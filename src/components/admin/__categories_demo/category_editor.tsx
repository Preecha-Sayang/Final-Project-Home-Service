...
import type { HexColor, CategoryCreateInput, CategoryRow } from "@/types/__category";
import { createCategory, getCategory, updateCategory } from "lib/client/__categoriesApi";
                ...
                <div className="grid gap-6">
                    ...
                    <div className="grid grid-cols-12 items-center gap-3">
                        ...
                        <div className="col-span-10 flex items-center gap-3">
                            <input type="color" value={bg} onChange={(e) => setBg(e.target.value as HexColor)} />
                            <input className="h-10 rounded border px-3 w-40" value={bg}
                                onChange={(e) => setBg(e.target.value as HexColor)} />
                            <div className="h-8 w-16 rounded" style={{ backgroundColor: bg }} />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 items-center gap-3">
                        ...
                        <div className="col-span-10 flex items-center gap-3">
                            <input type="color" value={text} onChange={(e) => setText(e.target.value as HexColor)} />
                            <input className="h-10 rounded border px-3 w-40" value={text}
                                onChange={(e) => setText(e.target.value as HexColor)} />
                            <div className="h-8 w-16 rounded border" style={{ backgroundColor: text }} />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 items-center gap-3">
                        ...
                        <div className="col-span-10 flex items-center gap-3">
                            <input type="color" value={ring} onChange={(e) => setRing(e.target.value as HexColor)} />
                            <input className="h-10 rounded border px-3 w-40" value={ring}
                                onChange={(e) => setRing(e.target.value as HexColor)} />
                            <div className="h-8 w-16 rounded" style={{ boxShadow: `0 0 0 3px ${ring}` }} />
                        </div>
                    </div>
