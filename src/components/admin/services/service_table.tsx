            ...
            <table className="w-full table-fixed border-collapse">
                <thead>
                    <tr className="bg-[var(--gray-100)] text-base text-[var(--gray-500)]">
                        ...
                        <th className="w-[58px] px-1 py-3 text-center font-[400]">ลำดับ</th>
                        <th className="w-[226px] px-3 py-1 text-left font-[400]">ชื่อบริการ</th>
                        <th className="w-[225px] px-1 py-3 text-left font-[400]">หมวดหมู่</th>
                        <th className="w-[209px] px-1 py-3 text-left font-[400]">สร้างเมื่อ</th>
                        <th className="w-[209px] px-1 py-3 text-left font-[400]">แก้ไขล่าสุด</th>
                        <th className="w-[120px] px-1 py-3 text-center font-[400]">Action</th>
                    </tr>
                </thead>
                        ...
                        filtered.map((row) => {
                            ...
                            return (
                                <tr
                                    ...
                                    className="group h-[88px] border-t border-[var(--gray-100)] text-base hover:bg-[var(--gray-100)] cursor-pointer transition"
                                >
                                    <td className="px-5 py-3 text-center text-[var(--gray-400)]" data-drag="handle">
                                        <GripVertical className="h-6 w-6 cursor-grab text-[var(--gray-300)]" />
                                    </td>
