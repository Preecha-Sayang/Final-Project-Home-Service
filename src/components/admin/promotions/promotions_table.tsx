            ...
            <table className="w-full table-fixed border-collapse">
                <thead className="font-medium">
                    <tr className="bg-[var(--gray-100)] text-sm text-[var(--gray-600)]">
                        ...
                        <th className="w-[120px] px-1 py-3 pl-6">
                            {th("สถานะ", "expire_at")}
                        </th>
                        <th className="w-[120px] px-1 py-3">Action</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    {rows.map((r) => {
                        ...
                        return (
                            <tr
                                key={r.promotion_id}
                                className="group border-t border-[var(--gray-100)] text-base font-medium hover:bg-[var(--gray-100)] cursor-pointer"
                            ...
                            >
                                ...
                                {/* สถานะ */}
                                <td className="px-1 py-3 pl-9 text-left">
                                    <span
                                        ...
                                        >
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                <path
                                                    ...
                                                    stroke="#9AA1B0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                                                />
                                            </svg>
                                        </button>
                                        <button
