...
type Props = {
    ...
    declineLabel?: string;   // ปุ่มซ้าย
    doneLabel?: string;      // ปุ่มขวา
    loading?: boolean;
...
export default function ConfirmManageJob({
    open,
    title = "จัดการงาน",
    description,
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/30 p-4">
            <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
                ...
                <h3 className="mb-1 text-center text-lg font-semibold text-[var(--gray-900)]">
                    {title}
                </h3>
                {description && (
