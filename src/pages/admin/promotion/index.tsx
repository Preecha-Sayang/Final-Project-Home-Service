    ...
    return (
        <>
            <div className="w-full bg-white rounded-2xl border border-gray-100 px-5 py-4 mb-6 flex items-center justify-between">
                <div className="text-xl font-medium text-gray-900">Promotion Code</div>
                <div className="flex items-center gap-2">
                    ...
                    <button
                        onClick={() => router.push("#")}
                        className="h-9 rounded-lg bg-blue-600 px-6 text-sm font-medium text-white hover:bg-blue-700 cursor-pointer"
                    >
