...
export default function ServiceDetailPage() {
    ...
    if (!id) return null;
    if (loading) return <div className="rounded-2xl border border-gray-100 bg-white p-6">Loading…</div>;
    if (!item) return <div className="rounded-2xl border border-gray-100 bg-white p-6">ไม่พบข้อมูล</div>;
