...
import type { CategoryOneOk, CategoryErr, CategoryRow } from "@/types/__category";
        ...
        const fetchOne = async (): Promise<void> => {
            ...
            try {
                ...
                if (!("ok" in data) || !data.ok) {
                    throw new Error(("message" in data && data.message) || "โหลดข้อมูลไม่สำเร็จ");
                }
                ...
                {loading ? (
                    ...
                    <div className="grid gap-6">
                        ...
                        <div className="grid grid-cols-12 items-center gap-4">
                            <div className="col-span-3 text-[var(--gray-600)]">ชื่อหมวดหมู่</div>
                    ...
                    <div className="py-12 text-center text-[var(--gray-500)]">ไม่พบข้อมูล</div>
                )}
            </div>
        </div>
    );
